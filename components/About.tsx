      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="flex items-start gap-3 bg-slate-50 p-4 rounded-xl border border-slate-200">
                ...
                <div>
                  <h4 className="text-sm font-bold text-slate-900">Lokasi Strategis</h4>
                  <p className="text-xs text-slate-500 mt-0.5">Mudah dijangkau di Jalan Arwinda No.49 Tajurhalang, Cianjur.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 bg-slate-50 p-4 rounded-xl border border-slate-200">
                ...
                <div>
                  <h4 className="text-sm font-bold text-slate-900">Buka 24/7 Nonstop</h4>
                  <p className="text-xs text-slate-500 mt-0.5">Selalu siap kapan saja Anda membutuhkan aki baru.</p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-5">
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 relative overflow-hidden shadow-md">
              <div className="absolute top-0 right-0 w-32 h-32 bg-brand-600/5 rounded-full blur-2xl pointer-events-none" />
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="font-extrabold text-slate-900 text-lg">Komitmen Pelayanan</h3>
                  <p className="text-xs text-slate-500">Kepercayaan & Kepuasan Pelanggan</p>
                </div>
              </div>

              <blockquote className="text-slate-600 text-sm italic leading-relaxed border-l-2 border-brand-600 pl-4 py-1">
              ...
              <div className="mt-6 pt-6 border-t border-slate-200 flex items-center justify-between text-xs font-medium">
                <span className="text-slate-500">Toko Aki Cianjur</span>
                <span className="text-brand-600 font-bold">Cahaya Baru Aki 2</span>
              </div>
            </div>
          </div>
