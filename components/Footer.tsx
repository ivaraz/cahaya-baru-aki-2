        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <Link href="#beranda" className="hover:text-slate-950 transition-colors">
                  Beranda
                </Link>
              </li>
              <li>
                <Link href="#keunggulan" className="hover:text-slate-950 transition-colors">
                  Keunggulan Usaha
                </Link>
              </li>
              <li>
                <Link href="#produk" className="hover:text-slate-950 transition-colors">
                  Katalog Produk Aki
                </Link>
              </li>
              <li>
                <Link href="#layanan" className="hover:text-slate-950 transition-colors">
                  Layanan &amp; Jasa
                </Link>
              </li>
              <li>
                <Link href="#tentang" className="hover:text-slate-950 transition-colors">
                  Tentang Kami
                </Link>
              </li>
              <li>
                <Link href="#lokasi" className="hover:text-slate-950 transition-colors">
                  Lokasi Toko
                </Link>
              </li>
            </ul>
          ...
          <div className="lg:col-span-4 space-y-3">
            ...
            <div className="space-y-2.5 text-xs">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="tel:081809833193" className="text-slate-700 hover:text-slate-950">
                  0818-0983-3193
                </a>
              </div>
              ...
              <div className="pt-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 text-brand-600 hover:text-brand-700 text-xs font-semibold"
                >
